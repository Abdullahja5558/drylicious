...
const categories = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1532336414038-cf19250c5757?q=80&w=2000&auto=format&fit=crop",
    slug: "best-sellers",
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1509358271058-acd22cc93898?q=80&w=2000&auto=format&fit=crop",
    slug: "whole-spices",
...
const Categories = () => {
  return (
    <section
      className="py-32 bg-[#FBF9F4] px-6 overflow-hidden"
      id="collection"
    >
      <div className="max-w-[1400px] mx-auto">
        {" "}
        {/* Max width slightly increased for 4 items */}
        {/* --- HEADER --- */}
        <div className="flex flex-col items-center text-center mb-24">
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.6em] text-orange-900/40">
              The Collection
            </span>
            <div className="h-[1px] w-8 md:w-16 bg-orange-900/20" />
          </motion.div>
              ...
              >
                ...
                <div className="relative w-full aspect-[4/6] overflow-hidden rounded-t-[120px] rounded-b-[30px] bg-stone-100 group-hover:shadow-[0_60px_100px_-30px_rgba(180,83,9,0.15)] transition-all duration-[1.5s]">
                  ...
                  <div className="absolute top-6 right-6 z-20">
                    <div
                      className={`px-4 py-1.5 rounded-full border bg-white/40 backdrop-blur-md text-[8px] font-black uppercase tracking-widest transition-all duration-700 group-hover:bg-white group-hover:scale-110 ${item.theme} ${item.border}`}
                    >
                      {item.price}
                    </div>
                  </div>
                  ...
                  <motion.img
                    src={item.image}
                    alt={`Category: ${item.title} - Drylicious`}

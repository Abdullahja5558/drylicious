...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "Unlike mass-produced spices, Drylicious focuses on stone-ground processing. This traditional method ensures that the natural oils and volatile aromas are preserved, giving you a much deeper flavor and authentic color.",
  },
  {
    question: "Do you use any artificial colors or preservatives?",
    answer:
      "Absolutely not. Our promise is 100% purity. We don't use lead chromate, artificial food colors, or anti-caking agents. What you get is the raw, organic essence of the spice.",
  },
  {
    question: "How should I store my premium spices to maintain freshness?",
    answer:
      "We recommend keeping them in our air-tight glass jars, away from direct sunlight and moisture. Heat is the enemy of aroma, so a cool, dark pantry is the perfect home for your Drylicious collection.",
  },
  {
    question: "Do you offer wholesale rates for restaurants or bulk buyers?",
    answer:
      "Yes, we have a dedicated wholesale program for culinary professionals and retailers. You can visit our 'Wholesale' page or contact us directly via WhatsApp for a customized quote.",
  },
  {
    question: "How long does shipping take within Pakistan?",
    answer:
      "Standard delivery typically takes 3-5 business days. Each order is packed with care to ensure the jars arrive safely at your doorstep.",
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-[#D7BDB1]">
              Assistance
            </span>
          </motion.div>
          ...
          >
            Common{" "}
            <span className="text-[#D7BDB1] italic font-light font-serif">
              Inquiries
            </span>
          </motion.h2>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <span
                  className={`text-lg md:text-xl font-medium tracking-tight transition-colors duration-300 cursor-pointer ${activeId === index ? "text-[#D7BDB1]" : "text-[#1a1a1a]"}`}
                >
                  {faq.question}
                </span>
                <div
                  className={`p-2 rounded-full transition-all duration-500 ${activeId === index ? "bg-[#D7BDB1] text-white rotate-180" : "bg-black/[0.05] text-[#1a1a1a]"}`}
                >
                  {activeId === index ? (
                    <Minus size={18} />
                  ) : (

...
import { Facebook, Instagram, MessageCircle, Heart, ExternalLink, MessageSquareText } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center lg:items-end mb-16 md:mb-24 gap-10 text-center lg:text-left">
          <div className="max-w-2xl">
            ...
            >
              Connected by <br /> 
              <span className="italic font-light text-orange-900/20">Authenticity.</span>
            </motion.h2>
          </div>
          ...
          >
            {[
              ...
              { icon: <MessageSquareText />, url: "https://wa.me/923367999509" }
            ].map((social, i) => (
              <a 
                key={i} 
                href={social.url} 
            ...
            >
              ...
              <div className="relative z-10 p-6 md:p-8 flex justify-between items-start">
                <div className="backdrop-blur-xl bg-white/90 p-3 px-4 rounded-2xl border border-white/40 shadow-xl flex items-center gap-2">
                  {post.icon}
                  <span className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-800">{post.platform}</span>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex gap-6 items-center">
                    <div className="flex items-center gap-2 text-white/90">
                      <Heart size={18} className="group-hover:fill-red-500 group-hover:text-red-500 transition-colors duration-300" />
                      <span className="text-[10px] font-black tracking-widest">{post.stats}</span>
                    </div>
                    <div className="flex items-center gap-2 text-white/90">
        ...
        >
          ...
          <div className="flex items-center gap-4">
             ...
             <p className="text-xs font-medium text-gray-500 tracking-wide">Join <span className="text-orange-900 font-bold">120k+ others</span> on our digital journey and digital family of organic enthusiasts </p>

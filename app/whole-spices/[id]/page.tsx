          ...
          <div className="lg:col-span-5 flex flex-col pt-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-[#333333] font-light leading-relaxed italic border-l-2 border-orange-900/10 pl-8">
                "Our {spice.name} is selected for its high essential oil
                content, ensuring maximum potency in every {selectedWeight}g
                pack."
              </p>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 w-full p-4 z-[110] bg-gradient-to-t from-[#FBF9F4] via-[#FBF9F4] to-transparent">
        <div className="max-w-md mx-auto flex items-center gap-2">
          ...
          <a
            ...
            className="flex-none p-5 bg-emerald-50 text-emerald-600 border border-emerald-100 rounded-[20px] shadow-xl active:scale-95"
          >
            <MessageCircle
              size={22}
              fill="currentColor"
          ...
          <button
            onClick={handleAddToCart}
            className="flex-none p-5 bg-white border border-black/10 rounded-[20px] shadow-xl active:scale-95"
          >
            <ShoppingBag size={22} />
          </button>

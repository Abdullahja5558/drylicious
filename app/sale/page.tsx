...
// --- EXPANDED SALE PRODUCTS (Whole + Pure Spices) ---
const SALE_ITEMS = [
  { id: 'green-cardamom', name: "Sabz Ilaichi", oldPrice: 3850, newPrice: 3450, weight: "250g", image: "/ilaiche.jpeg", tag: "Flash Sale", category: "whole-spices", note: "Super Bold 8mm" },
  { id: 'black-pepper', name: "Kali Mirch Sabit", oldPrice: 850, newPrice: 725, weight: "250g", image: "/black-pepper.png", tag: "Limited Deal", category: "whole-spices", note: "Steam Washed" },
  { id: 'garlic-powder', name: "Garlic Powder", oldPrice: 650, newPrice: 525, weight: "250g", image: "/garlic-powder.jpeg", tag: "Hot Price", category: "pure-spices", note: "Extra Fine" },
  { id: 'cumin', name: "Safaid Zeera", oldPrice: 550, newPrice: 450, weight: "250g", image: "/zera.jpeg", tag: "Best Seller", category: "whole-spices", note: "Aromatic" },
  { id: 'cloves', name: "Long (Cloves)", oldPrice: 1100, newPrice: 950, weight: "250g", image: "/long.png", tag: "Heritage Pick", category: "whole-spices", note: "Hand-Picked" },
  { id: 'ginger-powder', name: "Ginger Powder", oldPrice: 750, newPrice: 600, weight: "250g", image: "/ginger-powder.jpeg", tag: "Chef's Choice", category: "pure-spices", note: "Sun Dried" },
  { id: 'cinnamon', name: "Dar Chini", oldPrice: 400, newPrice: 300, weight: "250g", image: "/dar-chini.jpeg", tag: "Top Rated", category: "whole-spices", note: "Ceylon Origin" },
  { id: 'star-anise', name: "Badiyan-e-Khatai", oldPrice: 550, newPrice: 425, weight: "250g", image: "/star-anise.jpeg", tag: "Daily Essential", category: "pure-spices", note: "Whole Quality" },
  { id: 'white-pepper', name: "Safed Mirch", oldPrice: 1000, newPrice: 800, weight: "250g", image: "/safed-mirch.jpeg", tag: "Delicate", category: "whole-spices", note: "Gourmet Standard" },  

];

const SalePage = () => {
  // --- PREMIUM TIMER LOGIC (Auto-Reset) ---
    ...
    const timer = setInterval(() => {
      setTimeLeft(prev => {
        if (prev.hours === 0 && prev.minutes === 0 && prev.seconds === 0) {
          return { hours: 2, minutes: 59, seconds: 59 }; // Reset to 3 Hours
        }
      ...
      <main className="max-w-[1400px] mx-auto px-6 pt-40 pb-20">
        ...
        <header className="mb-32 text-center relative">
          <motion.div
            ...
            className="inline-flex items-center gap-6 px-10 py-5 bg-[#111111] text-white rounded-[30px] mb-12 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.4)] relative overflow-hidden group"
          >
          ...
          <p className="max-w-xl mx-auto text-sm md:text-xl font-light text-gray-400 italic leading-relaxed">
            "Rare opportunities to stock your kitchen with our heritage collection at exceptional value."
          </p>
        </header>

        {/* --- SALE GRID (Best Seller Style) --- */}
            ...
            <Link href={`/${item.category}/${item.id}`} key={item.id}>
              ...
              >
                ...
                <div className="relative aspect-[3/4] rounded-[70px] overflow-hidden bg-stone-100 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.06)] group-hover:shadow-[0_80px_100px_-20px_rgba(180,83,9,0.12)] transition-all duration-1000">
                  ...
                  {/* Rating/Sold info can stay or go, maine clean look ke liye rakha hai */}
